...
<div class="container">
  <div class="row top">
    <form name = "form1" action="<?php echo base_url();?>caretaker" method="post" enctype="multipart/form-data">
    <div class="col-sm-3 col-md-2">
      <div class="col-md-2"></div>
      
        <ul class="nav nav-pills nav-stacked ">
          <li class="active"><input type="submit" name="action" class="btn btn-primary" value="Not Arrived" style="width:165px"><!-- <i><?php echo $pending_count; ?></i> --></li>
          <li class="active"><input type="submit" name="action" class="btn btn-primary" value="Arrived" style="width:165px"></li>
          <li class="active"><input type="submit" name="action" class="btn btn-primary" value="Left" style="width:165px"></li>
        ...
        <div class="tab-pane fade in active" id="official">
          <div class="list-group col-xs-12">
            <?php foreach ($official->result_array() as $sub) { ?>
                <a href="<?php echo base_url(); ?>test3/<?php echo $sub['application_number'];?>">
